...
public:
    ItemsAndHUD();
    ItemsAndHUD(float x, float y, int currentFrame = 1, float width = 16.5, float height = 17,
        int numberOfAnimatedTiles = 1, LPCWSTR fileSpriteName = SPRITE_ITEMS_AND_HUD_PATH);
